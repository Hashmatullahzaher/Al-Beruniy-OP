...
export interface Project {
  ...
  createdByUser?: boolean | undefined // local demo-added project
}
...
export interface Floor {
  ...
  use: FloorUse
  name?: string | undefined // optional descriptive name, e.g. "Amenities & Hospitality"
  createdByUser?: boolean | undefined
}
...
export interface Unit {
  ...
  planLabel?: string | undefined // marketing plan label, e.g. "C-3"
  planImage?: string | undefined // /plans/c-3.jpg or an uploaded data URL
...
export interface ConstructionUpdate {
  ...
  date: string // ISO
  thumbnailUrl: string
  videoUrl?: string | undefined // when present, a real clip; otherwise a demo-video modal
  description: string
...
export interface Customer {
  ...
  code?: string | undefined // human-facing customer ID, e.g. "MM-2026-0142"
  phone: string // masked demo phone
  whatsapp?: string | undefined
  email: string
  address?: string | undefined
  occupation?: string | undefined
  photo?: string | undefined // uploaded data URL (optional)
